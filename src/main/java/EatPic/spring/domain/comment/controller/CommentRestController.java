...
public class CommentRestController {
    ...
    public ApiResponse<CommentResponseDTO.WriteCommentResponseDTO> writeComment(@PathVariable("cardId") Long cardId,
        ...
        return ApiResponse.<CommentResponseDTO.WriteCommentResponseDTO>builder()
                ...
                .result(CommentConverter.CommentToWriteCommentResponseDTO(comment))
                .build();
    }
    ...
    public ApiResponse<CommentResponseDTO.commentListDTO> writeComment(@PathVariable("cardId") Long cardId,
        ...
        return ApiResponse.<CommentResponseDTO.commentListDTO>builder()
